...
//   return (
//     <div className="min-h-screen bg-[#F6F6F7] dark:bg-gray-900 transition-all duration-300">
//       <header className="sticky top-0 z-50 backdrop-blur-lg bg-white/50 dark:bg-gray-900/50 border-b">
//         <div className="container mx-auto flex justify-between items-center p-4">
//           <div className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent animate-fade-in">
//             RP2 - Rounded Professional Programme
...
//             <Button 
//               variant="ghost" 
//               className="hover:scale-105 transition-transform bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white"
//             >
//               <LogInIcon className="mr-2 h-4 w-4" /> Login
//             </Button>
//             <Button 
//               className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white hover:scale-105 transition-transform"
//             >
//               <UserPlusIcon className="mr-2 h-4 w-4" /> Register
//             </Button>
//             <Button 
